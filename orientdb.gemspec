...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/jars/blueprints-orient-graph-2.5.0-SNAPSHOT_ME.jar",
    "lib/jars/orient-commons-1.6.1.jar",
    "lib/jars/orientdb-core-1.6.1.jar",
    "lib/jars/orientdb-client-1.6.1.jar",
    "lib/jars/jna-4.0.0.jar",
    "lib/jars/orientdb-nativeos-1.6.1.jar",
    "lib/jars/orientdb-distributed-1.6.1.jar",
    "lib/jars/orientdb-enterprise-1.6.1.jar",
    "lib/jars/orientdb-graphdb-1.6.1.jar",
    "lib/jars/orientdb-object-1.6.1.jar",
    "lib/jars/orientdb-server-1.6.1.jar",
    "lib/jars/orientdb-tools-1.6.1.jar",
